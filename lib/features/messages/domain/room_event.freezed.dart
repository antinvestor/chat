...
mixin _$RoomEvent {
 ...
 RoomEventType get type; Map<String, dynamic> get content; String? get parentId; EventStatus get status; int get createdAt; int? get serverTs; String? get localId; int? get editedAt;// Timestamp when message was last edited
 bool get redacted;// Whether message is deleted
 int? get redactedAt;// Timestamp when message was deleted
 String? get redactedBy;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RoomEvent&&(identical(other.id, id) || other.id == id)&&(identical(other.roomId, roomId) || other.roomId == roomId)&&(identical(other.senderId, senderId) || other.senderId == senderId)&&(identical(other.senderContactId, senderContactId) || other.senderContactId == senderContactId)&&(identical(other.type, type) || other.type == type)&&const DeepCollectionEquality().equals(other.content, content)&&(identical(other.parentId, parentId) || other.parentId == parentId)&&(identical(other.status, status) || other.status == status)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.serverTs, serverTs) || other.serverTs == serverTs)&&(identical(other.localId, localId) || other.localId == localId)&&(identical(other.editedAt, editedAt) || other.editedAt == editedAt)&&(identical(other.redacted, redacted) || other.redacted == redacted)&&(identical(other.redactedAt, redactedAt) || other.redactedAt == redactedAt)&&(identical(other.redactedBy, redactedBy) || other.redactedBy == redactedBy));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,roomId,senderId,senderContactId,type,const DeepCollectionEquality().hash(content),parentId,status,createdAt,serverTs,localId,editedAt,redacted,redactedAt,redactedBy);

@override
String toString() {
  return 'RoomEvent(id: $id, roomId: $roomId, senderId: $senderId, senderContactId: $senderContactId, type: $type, content: $content, parentId: $parentId, status: $status, createdAt: $createdAt, serverTs: $serverTs, localId: $localId, editedAt: $editedAt, redacted: $redacted, redactedAt: $redactedAt, redactedBy: $redactedBy)';
}
...
@useResult
$Res call({
 String id, String roomId, String senderId, String? senderContactId, RoomEventType type, Map<String, dynamic> content, String? parentId, EventStatus status, int createdAt, int? serverTs, String? localId, int? editedAt, bool redacted, int? redactedAt, String? redactedBy
});
...
/// Create a copy of RoomEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? roomId = null,Object? senderId = null,Object? senderContactId = freezed,Object? type = null,Object? content = null,Object? parentId = freezed,Object? status = null,Object? createdAt = null,Object? serverTs = freezed,Object? localId = freezed,Object? editedAt = freezed,Object? redacted = null,Object? redactedAt = freezed,Object? redactedBy = freezed,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,roomId: null == roomId ? _self.roomId : roomId // ignore: cast_nullable_to_non_nullable
as String,senderId: null == senderId ? _self.senderId : senderId // ignore: cast_nullable_to_non_nullable
as String,senderContactId: freezed == senderContactId ? _self.senderContactId : senderContactId // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String roomId,  String senderId,  String? senderContactId,  RoomEventType type,  Map<String, dynamic> content,  String? parentId,  EventStatus status,  int createdAt,  int? serverTs,  String? localId,  int? editedAt,  bool redacted,  int? redactedAt,  String? redactedBy)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RoomEvent() when $default != null:
return $default(_that.id,_that.roomId,_that.senderId,_that.senderContactId,_that.type,_that.content,_that.parentId,_that.status,_that.createdAt,_that.serverTs,_that.localId,_that.editedAt,_that.redacted,_that.redactedAt,_that.redactedBy);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String roomId,  String senderId,  String? senderContactId,  RoomEventType type,  Map<String, dynamic> content,  String? parentId,  EventStatus status,  int createdAt,  int? serverTs,  String? localId,  int? editedAt,  bool redacted,  int? redactedAt,  String? redactedBy)  $default,) {final _that = this;
switch (_that) {
case _RoomEvent():
return $default(_that.id,_that.roomId,_that.senderId,_that.senderContactId,_that.type,_that.content,_that.parentId,_that.status,_that.createdAt,_that.serverTs,_that.localId,_that.editedAt,_that.redacted,_that.redactedAt,_that.redactedBy);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String roomId,  String senderId,  String? senderContactId,  RoomEventType type,  Map<String, dynamic> content,  String? parentId,  EventStatus status,  int createdAt,  int? serverTs,  String? localId,  int? editedAt,  bool redacted,  int? redactedAt,  String? redactedBy)?  $default,) {final _that = this;
switch (_that) {
case _RoomEvent() when $default != null:
return $default(_that.id,_that.roomId,_that.senderId,_that.senderContactId,_that.type,_that.content,_that.parentId,_that.status,_that.createdAt,_that.serverTs,_that.localId,_that.editedAt,_that.redacted,_that.redactedAt,_that.redactedBy);case _:
  return null;
...
class _RoomEvent extends RoomEvent {
  const _RoomEvent({required this.id, required this.roomId, required this.senderId, this.senderContactId, required this.type, required final  Map<String, dynamic> content, this.parentId, this.status = EventStatus.pending, required this.createdAt, this.serverTs, this.localId, this.editedAt, this.redacted = false, this.redactedAt, this.redactedBy}): _content = content,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,roomId,senderId,senderContactId,type,const DeepCollectionEquality().hash(_content),parentId,status,createdAt,serverTs,localId,editedAt,redacted,redactedAt,redactedBy);
...
/// Create a copy of RoomEvent
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? roomId = null,Object? senderId = null,Object? senderContactId = freezed,Object? type = null,Object? content = null,Object? parentId = freezed,Object? status = null,Object? createdAt = null,Object? serverTs = freezed,Object? localId = freezed,Object? editedAt = freezed,Object? redacted = null,Object? redactedAt = freezed,Object? redactedBy = freezed,}) {
