...
@ProviderFor(uploadProgressStream)
final uploadProgressStreamProvider = UploadProgressStreamProvider._();

/// Stream provider for real-time progress updates
///
/// Use when you need a stream of all progress events

final class UploadProgressStreamProvider
    extends
        $FunctionalProvider<
          AsyncValue<UploadProgress>,
          UploadProgress,
          Stream<UploadProgress>
        >
    with $FutureModifier<UploadProgress>, $StreamProvider<UploadProgress> {
  /// Stream provider for real-time progress updates
  ///
  /// Use when you need a stream of all progress events
  UploadProgressStreamProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
        name: r'uploadProgressStreamProvider',
        isAutoDispose: true,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$uploadProgressStreamHash();

  @$internal
  @override
  $StreamProviderElement<UploadProgress> $createElement(
    $ProviderPointer pointer,
  ) => $StreamProviderElement(pointer);

  @override
  Stream<UploadProgress> create(Ref ref) {
    return uploadProgressStream(ref);
  }
}

String _$uploadProgressStreamHash() =>
    r'65c41bb935e3ffd5f84d1b50662104457dc163d2';
