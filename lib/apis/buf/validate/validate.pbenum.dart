...
class Ignore extends $pb.ProtobufEnum {
  ...
  static final $core.List<Ignore?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 3);
  static Ignore? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
